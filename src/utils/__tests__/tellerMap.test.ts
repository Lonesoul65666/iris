...
// Cross-boundary import: the mapper lives server-side but is a pure function.
import { classifyTellerTxn, tellerTxnToExpense } from '../../../server/teller-map';
import type { TellerTransaction, TellerAccount } from '../../../server/teller-client';
