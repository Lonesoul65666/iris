...
export const sampleBudgetBuckets: BudgetBucket[] = [
  ...
  { category: 'amazon', label: 'Online Shopping', icon: '📦', monthlyBudget: 400, monthlyActual: 0, color: '#f97316', guideline: 'Amazon, Temu, Shein, AliExpress — all of it. One number to shrink; click through to see which merchant is doing the damage.', guidelinePercent: 2 },
...
export const defaultBudgetBuckets: BudgetBucket[] = [
  ...
  { category: 'amazon',          label: 'Online Shopping',         icon: '📦', monthlyBudget: 0, monthlyActual: 0, color: '#f97316', guideline: 'Amazon and the marketplaces. Track separately — online shopping is invisible spending.', guidelinePercent: 2 },
