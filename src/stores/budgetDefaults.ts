...
export const sampleBudgetBuckets: BudgetBucket[] = [
  ...
  { category: 'shopping_other', label: 'Online Shopping (other)', icon: '🛍️', monthlyBudget: 0, monthlyActual: 0, color: '#fb923c', guideline: 'Temu, Shein, AliExpress — the same invisible-spending shape as Amazon, kept out of the Amazon number so neither one hides the other.', guidelinePercent: 0.5 },
...
export const defaultBudgetBuckets: BudgetBucket[] = [
  ...
  { category: 'shopping_other',  label: 'Online Shopping (other)',  icon: '🛍️', monthlyBudget: 0, monthlyActual: 0, color: '#fb923c', guideline: 'Temu, Shein, AliExpress — same shape as Amazon, tracked apart from it.', guidelinePercent: 0.5 },
